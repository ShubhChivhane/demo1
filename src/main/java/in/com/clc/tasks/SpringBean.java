...
@EnableWebMvc
@ComponentScan({ "in.com.clc.*" })//this represents base packageToScan <context:component-scan base-package="com.clc.*">
...
public class SpringBean {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "in.com.clc.*" });
